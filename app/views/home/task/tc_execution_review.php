    	...
    	<div class="page-content page-content-popup">
			...
			<div class="page-content-fixed-header">
				<ul class="page-breadcrumb">
					...
					<li><?= $ticket ?> - Test Execution Review</li>
				</ul>
			</div>
						...
						<div class="portlet light bordered">
							<div class="portlet-title tabbable-line">
								<div class="caption font-blue">
									...
									<span class="caption-subject theme-font bold uppercase"><?= $ticket ?> - Test Execution Review</span>
								</div>
							</div>
												...
												<?php
													...
													foreach($currentTC as $k=>$ctc) {
														...
														echo '<div class="tab-pane '.$active.'" id="'.$ctc['tc_id']."_".$ctc['ts_id'].'">
																...
																<h3 class="margin-bottom-10"><b>Test Results</b></h3>
																<br>
																<div class="row">
																	<div class="col-md-10">';
																	$_results = "";
																	...
																	echo '<table class="table table-bordered" style="table-layout: fixed;">
																			...
																			foreach($decode_browser as $b) {
																				echo '<th style="text-align:center">' . $b['text'] . '</th>';
																			}
																	echo '</tr>
																		<tr>';
																			foreach($decode_browser as $b) {
																							...
																							echo '<div class="col-sm-12 col-md-4">
																									<div class="thumbnail">
																										...
																										<div class="caption">
																											<p> ' . $sc['description'] . ' </p>
																											<p>
																												<a class="fancybox-button" href="' . $sc['link'] . '" class="btn blue"><h4><span class="btn btn-s blue">View</span></h4></a>
																											</p>
																										</div>
																									</div>
																								</div>';
