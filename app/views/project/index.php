<?php
	$projectsList = $data['all_projects'];
?>
				...
				<div class="col-md-12">
					<div class="navbar navbar-default" role="navigation">
						<div class="navbar-header">
							<a class="navbar-brand" href="javascript:;">All Projects</a>
						</div>
					</div>
				</div>
				<div class="col-md-12">
					<a class="btn btn-s blue">Export Excel</a>
					<br><br>
					<table class="table table-bordered table-hover" id="projects_table">
						<thead>
							<tr>
								<th>Project Name</th>
								<th>Description</th>
								<th>JIRA-Linked Project</th>
								<th>JIRA-Linked Component</th>
								<th>Automation Connection</th>
							</tr>
						</thead>
						<tbody>
							<?php
								foreach($projectsList as $p) {
									echo "<tr>
											<td><a style='text-decoration:underline' href='Project/Project_Main/" .  $p['project_name']. "'>" . $p['project_name'] . "<a></td>
											<td>" . $p['project_description'] . "</td>
											<td>" . $p['jira_pname'] . "</td>
											<td>" . $p['jira_component'] . "</td>
											<td>" . $p['connection_name'] . "</td>
										</tr>";
								}
							?>
						</tbody>
