<?php
	...
	$localReleaseCount = $data['localReleaseCount'];
				...
				<div class="portlet box blue">
					<div class="portlet-title">
						...
						<div style='float:right; display:inline-block; margin-top:6px;'>
							<a href="#add_release" data-toggle="modal" class="btn default btn-sm" >Add Release</a>
						</div>
					</div>
					<div class="portlet-body">
						<div style='float:left; display:inline-block; margin-top:6px;'>
							<a class="btn blue btn-s" onclick="exportJiraReleases(this)" <?php echo "data-projectname='" . $project . "'"; ?>>Export Excel</a>
						</div>
						<br><br><br>
						<table class="table table-hover table-bordered multiple" id="one">
							<thead>
								<tr>
									<th>Release#</th>
									<th>Description
							...
							<tbody>
								<?php
									$_project = $project;
									$_component = "AllComponents";
									if($proj['jira_component'] != "") {
										$_component = $proj['jira_component'];
									}
									foreach($releases as $release) {
										...
										foreach($localReleaseCount as $releaseCount) {
											if($release['project_release_id'] == $releaseCount['project_release_id']) {
												...
												echo "<script>console.log('Equals " . $releaseCount['total_jira'] . "')</script>";
												break;
											}
										}
										...
										echo "<tr>".
											 "<td><a href='Jira/Ticket/" . $_project . "/" . $_component . "/" .$release['release_name'] . "' style='text-decoration:underline'>" . $release['release_name'] . "</a></td>"	.
											 "<td>" . $release['release_description'] . "</td>".
											  ...
											  "<td></td>".
											  "<td>" . $dateFormat . "</td>".
											 "<td><a href='' style='text-decoration:underline'>Delete</a></td>";
									}
								?>
							</tbody>
						</table>
		...
		<div class="modal-dialog ">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="post" action ="Jira/createRelease">
						<div class="form-group">
							<label class="col-md-3 control-label" style="margin-top:5px">Release #</label>
							<div class="col-md-9">
								<input class="form-control" placeholder="Enter Release" type="text" name="release_name">
							</div>
						</div>
						<input type="hidden" name="project_id" value="<?= $project_id ?>">
						<input type="hidden" name="release_type" value="Jira">
						<br><br>
...
function exportJiraReleases(identifier) {
	var project = $(identifier).data('projectname');

	openModal();
	$.ajax({
		url : "Jira/exportJiraReleases",
		type : "POST",
		data : {
			project : project
		},
