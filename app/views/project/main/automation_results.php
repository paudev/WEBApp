					...
					if($autoResults == "") {
						echo '<div class="col-md-12">
								<div class="note note-danger">
									...
									<p> This project currently do not have any automation set up. No automation details will be diplayed unless you do so. If you want to proceed viewing automation details for this project, please click <a href="Project/Manage/' . $project . '" style="text-decoration:underline">here</a>.
									</p>
								</div>
							</div>';
					} else {
						echo "<div class='col-md-12'>
								<div class='portlet box blue'>
									...
									<div class='portlet-body'>
										<a onclick='exportAutomationsList(this)' data-projectname='" . $project . "' class='btn btn-s blue' style='float:right;'>Export Excel</a>
										<br/><br/><br/>
										...
										foreach($autoResults as $ar) {
											echo "<tr>
													<td><a href='Project/ExecutionResults/" . $project . "/" . $ar['execid'] . "' style='text-decoration:underline'>Exec-" . $ar['execid'] . "</a></td>
													<td>" . $ar['totalPass'] . "</td>
													<td>" . $ar['totalFail'] . "</td>
													<td>" . $ar['totalSkip'] . "</td>
													<td>" . $ar['totalTestCase'] . "</td>
													<td>" . $ar['mintime'] . "</td>
													<td>" . $ar['maxtime'] . "</td>
													<td>" . $ar['elapsedtime'] . "</td>
													<td>" . $ar['sumtime'] . "</td>
												</tr>";
										}
										echo "</tbody>
...
function exportAutomationsList(identifier) {
	var project_name = $(identifier).data('projectname');

	var js_array = JSON.stringify(<?php echo json_encode($autoResults); ?>);

	openModal();
	$.ajax({
		url : "Project/exportAutomationsList",
		type : "POST",
		data : {
			project_name : project_name,
			automation_results : js_array
		},
