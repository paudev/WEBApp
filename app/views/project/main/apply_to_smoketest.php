    ...
    <div class="container-fluid" style='margin-top:-18px'>
    	<div class="page-content page-content-popup">
			...
			<div class="page-fixed-main-content">
				...
				<form method='post' id='atst'>
					<div class="col-md-9">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-gift"></i>Apply To SmokeTest
								</div>
							</div>
							<div class="portlet-body">
								<table class="table table-bordered atst_table" id="atst_table" >
									<thead>
										<tr>
											<th class='table-checkbox'>
												<input type='checkbox' id="select_all" class='group-checkable' value='1'>
											</th>
											<th>Test Case ID</th>
											<th>Description</th>
											<th>Result</th>
										...
										<?php
											foreach($test_cases as $er) {
												...
												if(!$er['screenshot'] == null) {
													$img = '<center><a href="data:image/jpeg;base64,'. base64_encode($er['screenshot']) .'" class="fancybox-button" ><span class="badge badge-roundless badge-danger">Click Here</span></a></center>';
												} else {
													$img = "<center><span class='badge badge-info badge-roundless' >No Image Found</span></center>";
												}

												if(strlen($er['errormessage']) > 300) {
													$ellipsis = "<h5> Error Message too long... </h5>" ;
												}

												echo '<tr>
														<td width="5%"><input type="checkbox" class=" tid" value="'.$er['tid'].'"></td>
													  	<td width="45%">'.$er['tid'].'</td>
													  	<td width="25%">'.$er['desc'].'</td>
													  	<td width="25%" style="color:white; font-weight:bold;" class="'.$color.'">'.$er['result'].'</td>
													</tr>';
											}
										?>
									</tbody>
					...
					<div class="col-md-3">
						<div class="portlet light">
							<div class="portlet-body">
								...
								<select class='form-control release' name='release_id' id='release_id'>
									<?php
										foreach($releases as $r) {
											echo "<option value='".$r['id']."'>".$r['rname']."</option>";
										}
									?>
								</select>
								<h4>What Browser?</h4>
									...
									<div class="icheck-list">
										<?php
											...
											foreach($browsers as $b) {
												if($counter == 0) {
													echo "<label><input name='browser' checked class='atst_browser' type='radio' style='margin-right:20px;' value='".$b['browser_id']."' >".$b['browser_name']. "</label>";
												} else {
													echo "<label><input name='browser' class='atst_browser' type='radio' style='margin-right:20px;' value='".$b['browser_id']."' >".$b['browser_name']. "</label>";
												}
												$counter++;
											}
										?>
								...
								<br>
								<input type='hidden' name='exec_id' value="<?= $execid ?>">
								<button class='btn blue form-control' type='submit'>Apply Changes</button>
							</div>
						</div>
					</div>
				</form>
