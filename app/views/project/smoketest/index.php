					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							<div style='float:left; display:inline-block; margin-top:6px;'>
								<a class="btn blue btn-s" onclick="exportReleases(this)" <?php echo "data-projectname='" . $project . "'"; ?>>Export Excel</a>
							</div>
							<br><br><br>
							<table class="table table-striped table-hover table-bordered multiple" id="one">
								...
								<?php
									foreach($releases as $release) {
										if(!$release['totalScenario'] == 0) {
											$test_completion = round(((($release['totalPass']+$release['totalFail'])/$release['totalScenario'])*100));
										} else {
											$test_completion = 0 ;
										}
										...
										echo "<tr>".
												"<td><a href='SmokeTest/Browser/".$project."/".$release['release_name']."' style='text-decoration:underline'>".$release['release_name']."</a></td>"	.
												"<td>".$release['totalPass']."</td>".
												"<td>".$release['totalFail']."</td>".
												"<td>".$release['totalPending']."</td>".
												"<td>".$release['totalNotStarted']."</td>".
		...
		<div class="modal-dialog ">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="post" action ="SmokeTest/createRelease">
						...
						<input type="hidden" name="release_type" value="SmokeTest">
						<br><br>
...
function exportReleases(identifier) {
	var project_name = $(identifier).data('projectname');

	openModal();
	$.ajax({
		url : "SmokeTest/exportReleases",
		type : "POST",
		data : {
